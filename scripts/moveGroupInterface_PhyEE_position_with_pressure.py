...
def main():
	...
	# dr = data_record()
	phantom_pose_base = [
		0.5525365416518268, -0.03, 0.059565, 0.7364889292374673, -0.6758251381983308, 0.025581563091360688, 0.013712406011579605
	  ]
	...
	try:
		...
		phantom_pose_test[2] = phantom_pose_base[2]-0.004
		target_waypoints.append(copy.deepcopy(phantom_pose_test))
		...
		phantom_pose_test[2] = phantom_pose_base[2]-0.002
		target_waypoints.append(copy.deepcopy(phantom_pose_test))
		phantom_pose_test[2] = phantom_pose_base[2]+0.02
		target_waypoints.append(copy.deepcopy(phantom_pose_test))
		...
		target_waypoints.append(copy.deepcopy(phantom_pose_test))
		phantom_pose_test = copy.deepcopy(phantom_pose_base)
		phantom_pose_test[2] = phantom_pose_test[2]-0.002
		target_waypoints.append(copy.deepcopy(phantom_pose_test))
		phantom_pose_test = copy.deepcopy(phantom_pose_base)
		phantom_pose_test[2] = phantom_pose_test[2]+0.03
		target_waypoints.append(copy.deepcopy(phantom_pose_test))
	...
	# 	phantom_pose_start[2] = phantom_pose_base[2]+0.06
	...
	# 	phantom_pose_base[2] = phantom_pose_base[2]+0.005
	# 	# phantom_pose_base[2] = phantom_pose_base[2]-0.004
	...
	# 	target_waypoints = []
	# 	phantom_pose_start = copy.deepcopy(phantom_pose_base)
	# 	phantom_pose_start[2] = phantom_pose_test[2]+0.1
	# 	target_waypoints.append(copy.deepcopy(phantom_pose_start))
	# 	pneumatic.panda.set_line_velocity_scale(0.1)
	# 	pneumatic.panda.go_to_muti_line_movement(target_waypoints,True)
