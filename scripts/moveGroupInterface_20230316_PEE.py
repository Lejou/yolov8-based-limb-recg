...
class ArduinoPneumaticActuator(object):
	...
	def set_main_limit_pressure(self,data):
		...
		self.lip_limit_pressure_pub(main_limit_pressure)

	def set_lip_limit_pressure(self,data):
		lip_limit_pressure = Float32()
		lip_limit_pressure.data = data
		self.lip_limit_pressure_pub(lip_limit_pressure)
...
def main():
	...
	Ground_pose_phantom1 = [0.5785164094497701, -0.3127039024881273, 0.046714246728562114, 0.30901218054934826, -0.9510016648486943, 0.0063676442779523725, 0.008218845462988332]
	...
	# 	# )
	# 	pneumatic.panda.read_current_pose(),Pose()
	...
	# 		sg_init_state=True
	# 		pneumatic.get_base_sg_value()
	# 	pneumatic.get_sealing_force()
	...
	try:
		...
		print("current_pose",wpose.position.z)
		...
		pneumatic.panda.go_to_waypoints(target_waypoints,True)
